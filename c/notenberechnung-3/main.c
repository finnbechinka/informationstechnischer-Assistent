...
void zulassungspruefung(int notenanzahl, double noten[]){
int i;
int fuenfen = 0;
for(i = 0; i < notenanzahl; i++){
if(noten[i] == 5){
...
if (fuenfen > 2){
    printf("Zu viele fuenfen fuer die Versetzung!\n");
    i = notenanzahl;
}
}
}
...
int main()
{
    ...
    if(durchschnitt != wunschDurchschnitt){
        printf("Der Durchschnitt weicht um %lg vom Wunschdurchschnitt ab!\n", durchschnitt-wunschDurchschnitt);
    }
    zulassungspruefung(notenanzahl, noten);
    return 0;
}
